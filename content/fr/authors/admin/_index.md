...
role: Doctorant en archéologie numérique
...
Vous êtes sur le camp de base de Jérémy Garniaux. Géographe et cartographe, je suis doctorant en archéologie numérique au [LAMPEA](https://lampea.cnrs.fr) et à [Oslandia](https://oslandia.com), où je travaille sur les pratiques des archéologues en matière de 3D géospatiale, et sur la conception d'interfaces web spécialisées pour la consultation et l'analyse collaboratives de jumeaux numériques de sites archéologiques. Je suis aussi le [fondateur](https://mapper.fr/blog/2022-12/introducing-mapstodon/) de [Mapstodon.Space](https://mapstodon.space), une instance Mastodon multilingue dédiée à la cartographie. Bonne visite !
